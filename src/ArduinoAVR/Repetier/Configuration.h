...
#define RETRACTION_Z_LIFT 0.075
...
#elif MOTHERBOARD==45
#define MOTOR_CURRENT {135,135,135,135,135} // Values 0-255 (bqcnc 135 = ~0.75A, 185 = ~1A)
#endif
...
#define UI_PRINTER_NAME "bq Witbox"
#define UI_PRINTER_COMPANY "bqCNC & bqLCD"
